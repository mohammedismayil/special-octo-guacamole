...
<div className="my-5 flex justify-center content-center ">
               ...
               //
                <div className="background-image:http://traversymedia.com/downloads/assets/beachshowcase.jpg justify-center m-auto">
                    ...
                    <p className="text-2xl font-sans text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi officiis ipsum officia numquam expedita ullam.</p>
                <div className="flex  justify-center pt-5">
                   

                <button className="text-xl font-sans px-5 py-2 rounded border-2">Read More</button>
             ...
             <div className="px-5 py-5 text-center bg-red-900">
